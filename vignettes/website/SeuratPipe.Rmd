---
title: SeuratPipe - Streamlining Seurat analysis
author:
...
package: SeuratPipe
vignette: |
  %\VignetteIndexEntry{SeuratPipe: Streamlining Seurat analysis}
...
# Introduction
The aim of the `SeuratPipe` package is to streamline and provide a reproducible computational analysis pipeline for single cell genomics. It aims to remove technical details from the user, enabling wet lab researchers to have an 'initial look' at the data themselves. 
...
## Ncells  3590290 191.8    6928878 370.1         NA  6928878 370.1
## Vcells 25372536 193.6   50623263 386.3      32768 50622718 386.3
```
...
## [1] sp_1.4-7           SeuratObject_4.1.0 Seurat_4.1.1       SeuratPipe_1.0.0  
## [5] BiocStyle_2.24.0  
## 
